...
class AverageTripsPerDayOfMonthTest implements Serializable {
    ...
    static void setUp() {
        ...
        spark  = SparkSession.builder()
                .appName("AverageTripsPerDayOfMonth")
                .master("local")
    ...
    void getTripsDatasetTest(){
        Dataset<Row> trips = AverageTripsPerDayOfMonth.getTripsDataset(spark,
    ...
    void getAverage(){
        Dataset<Row> trips = AverageTripsPerDayOfMonth.getTripsDataset(spark,
                properties.get("bixi.dataset.path" ) + "/trips/*");
        Dataset<Row> result = AverageTripsPerDayOfMonth.getDayOfMonthAverages(trips);
        result.show();
        assert result.collectAsList().get(0).getAs("day").toString().equals("01");
